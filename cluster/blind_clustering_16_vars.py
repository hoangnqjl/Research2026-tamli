...
sys.stdout = DualLogger("analysis_results.txt")
...
if not os.path.exists(data_path):
    # Try looking in parent directories if run from subfolder
    if os.path.exists('../../Data.xlsx'):
        data_path = '../../Data.xlsx'
    else:
        print(f"Error: Data.xlsx not found at '{data_path}' or '../../Data.xlsx'")
        sys.exit(1)
...
# 6. EXPORT TO EXCEL
output_file = 'blind_clustering_final.xlsx'
